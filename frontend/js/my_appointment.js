...
const api = "https://3ce353abbeccd1.lhr.life/api/make";
if(user_id){
...
function payAmount(id, fees, doc_id) {
    ...
    if(amount < fees) {
        ...
        let payment_api = "https://3ce353abbeccd1.lhr.life/api/change_payment";
        let earnings_api = "https://3ce353abbeccd1.lhr.life/api/change_earnings";
