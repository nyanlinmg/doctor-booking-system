...
const related_doc_api = "https://3ce353abbeccd1.lhr.life/api/related_doctors";
...
async function receive_docData(api , doc_id) {
    try{
        ...
        doc_img.setAttribute('src', `https://3ce353abbeccd1.lhr.life${data.image}`);
...
function receive_day(doc_id) {
        const schedule_api = "https://3ce353abbeccd1.lhr.life/api/getSchedule";
                 ...
                 div.addEventListener('click', () => {
                    ...
                    if(isLoggedIn){
                        ...
                        book_btn.addEventListener('click', () => {
                            ...
                            const make_api = "https://3ce353abbeccd1.lhr.life/api/make";
