...
const api = "https://3ce353abbeccd1.lhr.life/api/paginateDoc";
            ...
            if(doc.available == 1){
                div.innerHTML = `
                    <a href="../html/doc_detail.html?doc_id=${doc.id}">
                        <img src="https://3ce353abbeccd1.lhr.life${doc.image}" alt="doc-1" class="w-[100%] h-70 object-cover bg-blue-200">
                ...
                div.innerHTML = `
                    <a href="../html/doc_detail.html?doc_id=${doc.id}">
                        <img src="https://3ce353abbeccd1.lhr.life${doc.image}" alt="doc-1" class="w-[100%]">
                        <div class="flex justify-start items-center ms-2 mt-5 mb-2">
