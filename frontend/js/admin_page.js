...
const app_api = "https://3ce353abbeccd1.lhr.life/api/make";
const user_api = "https://3ce353abbeccd1.lhr.life/api/create";
const latest_api = "https://3ce353abbeccd1.lhr.life/api/getLatestAppointments";
const del_api = "https://3ce353abbeccd1.lhr.life/api/delOldAppointments";
...
function latestBooking(data,show){
     ...
     data.forEach(element => {
        ...
        img.setAttribute('src', `https://3ce353abbeccd1.lhr.life${element.doctor.image}`);
...
doc_list.addEventListener('click', () => {
    ...
    const api = "https://3ce353abbeccd1.lhr.life/api/home";
...
function create(data){
    ...
    for(let i = 0; i < data.length; i++){
            ...
            img.setAttribute('src', `https://3ce353abbeccd1.lhr.life${data[i].image}`);
...
async function addDoctorSchedule(value, schedules) {
    ...
    const book_api = "https://3ce353abbeccd1.lhr.life/api/bookingSlot";
...
const paginateApi = "https://3ce353abbeccd1.lhr.life/api/paginateUser";
let currentPage = 1;
let lastPage = 1;
    ...
    result.data.forEach(user => {
        ...
        box1.innerHTML = `
            <div class="flex flex-wrap gap-6 ms-2">
                <img class="w-[80px] h-[80px] rounded-full" src="https://3ce353abbeccd1.lhr.life${user.image}"></img>
                <div>   
