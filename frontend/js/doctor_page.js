...
const available_api = "https://3748e8650932be77-210-14-107-177.serveusercontent.com/api/change_available";
...
profile.addEventListener("click", () => {
    ...
    .then(data => {
        ...
        img.setAttribute('src', `https://3748e8650932be77-210-14-107-177.serveusercontent.com${data.image}`);
...
const doc_appointments_api = "https://3748e8650932be77-210-14-107-177.serveusercontent.com/api/doc_appointments";
const action_api = "https://3748e8650932be77-210-14-107-177.serveusercontent.com/api/make_action";
let btnBox;
let btnBox2;
...
appointments.addEventListener('click', () => {
    ...
    .then(result => {
        ...
        result.data.forEach(element => {
            ...
            let img = document.createElement('img');
            img.setAttribute('src', `https://3748e8650932be77-210-14-107-177.serveusercontent.com${element.user.image}`);
            ...
            `
                ...
                <td>
                    <div class="flex items-center gap-3">
                            <img class="w-[40px] h-[40px] rounded-full" src="https://3748e8650932be77-210-14-107-177.serveusercontent.com${element.user.image}" alt="image">
...
const user_api = "https://3748e8650932be77-210-14-107-177.serveusercontent.com/api/get_user";
const latest_api = "https://3748e8650932be77-210-14-107-177.serveusercontent.com/api/latest_appointments";
